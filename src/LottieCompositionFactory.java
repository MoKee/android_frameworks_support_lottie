...
import frameworks.support.lottie.model.LottieCompositionCache;
import frameworks.support.lottie.network.NetworkFetcher;
import frameworks.support.lottie.parser.LottieCompositionMoshiParser;
...
import static frameworks.support.lottie.parser.moshi.JsonReader.*;
import static frameworks.support.lottie.utils.Utils.closeQuietly;
...
public class LottieCompositionFactory {
  ...
  @WorkerThread
  public static LottieResult<LottieComposition> fromJsonReaderSync(frameworks.support.lottie.parser.moshi.JsonReader reader, @Nullable String cacheKey) {
  ...
  private static LottieResult<LottieComposition> fromJsonReaderSyncInternal(
      frameworks.support.lottie.parser.moshi.JsonReader reader, @Nullable String cacheKey, boolean close) {
    try {
    ...
    try {
      ...
      while (entry != null) {
        ...
        if (entryName.contains("__MACOSX")) {
          ...
          frameworks.support.lottie.parser.moshi.JsonReader reader = of(buffer(source(inputStream)));
