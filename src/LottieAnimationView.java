...
import frameworks.support.lottie.value.SimpleLottieValueCallback;
...
import static frameworks.support.lottie.RenderMode.HARDWARE;
import static frameworks.support.lottie.RenderMode.SOFTWARE;
...
@SuppressWarnings({"unused", "WeakerAccess"}) public class LottieAnimationView extends AppCompatImageView {
  ...
  protected void onVisibilityChanged(@NonNull View changedView, int visibility) {
    ...
    // https://github.frameworks.support.lottie-android/issues/1143
   ...
   * @see frameworks.support.lottie.LottieDrawable#draw(android.graphics.Canvas)
   */
  @Override
